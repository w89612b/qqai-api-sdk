...
const resTerrorismKey = {"terrorists":	"恐怖分子","knife":	"刀","guns":	"枪支","blood":	"血液","fire":	"火","flag":	"旗帜","crowd":	"人群","other": "正常"} 
module.exports = class ImgPublicService {
  constructor(headers) {
      ...
      try {
        ...
        result.data.tag_list = result.data.tag_list.sort((a, b)=>{
          if(a.tag_confidence < b.tag_confidence){
            return 1;
          } else if(a.tag_confidence > b.tag_confidence){
            return -1;
          } else {
            return 0;
          }
  ...
  imagetag(param, res){
    imgPublic.imagetag(param).then(result => {
      res.write(JSON.stringify(result, null, 2));
      res.end();
    }, e => {
      res.write(JSON.stringify(e));
  ...
  imgidentify(param, res){
    imgPublic.imgidentify(param.image, param.scene).then(result => {
      res.write(JSON.stringify(result, null, 2));
      res.end();
    }, e => {
      res.write(JSON.stringify(e));
  ...
  imgtotext(param, res){
    imgPublic.imgtotext(param.image, param.sessionId).then(result => {
      res.write(JSON.stringify(result, null, 2));
      res.end();
    }, e => {
      res.write(JSON.stringify(e));
  ...
  imagefuzzy(param, res){
    imgPublic.imagefuzzy(param).then(result => {
      res.write(JSON.stringify(result, null, 2));
      res.end();
    }, e => {
      res.write(JSON.stringify(e));
  ...
  imagefood(param, res){
    imgPublic.imagefood(param).then(result => {
      res.write(JSON.stringify(result, null, 2));
      res.end();
    }, e => {
      res.write(JSON.stringify(e));
  ...
  inPost(param, res) {
    ...
    switch (param.index) {
      case 0:
        this.porn(param.image, res);
        break;
      case 1:
        this.terrorism(param.image, res)
        break;
      case 2:
        this.scener(param, res)
        break;
      case 3:
        this.objectr(param, res)
        break;
      case 4:
        this.imagetag(param.image, res)
        break;
      case 5:
        this.imgidentify(param, res)
        break;
      case 6:
        this.imgidentify(param, res)
        break;
      case 7:
        this.imgtotext(param, res)
        break;
      case 8:
        this.imagefuzzy(param.image, res)
        break;
      case 9:
        this.imagefood(param.image, res)
        break;
    }
  }
}
